<aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white {{ Route::is('jadwal') ? 'active bg-gradient-primary' : '' }}" href="{{ route('jadwal') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white {{ Route::is('barang') ? 'active bg-gradient-primary' : '' }}" href="{{ route('barang') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
